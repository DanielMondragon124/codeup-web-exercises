...
//     if (color === 'blue') {
//         return 'blue is the color of my pool';
//     } else if (color === 'red') {
...
var result = analyzeColor(userInput);
...
var input = prompt("What is your total bill amount?");
var bill = parseFloat(input);

var discountedPrice = calculateTotal(luckyNumber, bill);

alert("Your lucky number is " + luckyNumber + ". Your bill before the discount was $" + bill.toFixed(2) + ". Your bill after the discount is $" + discountedPrice.toFixed(2) + ".");
